...
import com.algaworks.osworks.api.dto.ComentarioInputDTO;
...
public class ComentarioController {
	...
	public ComentarioDTO adicionar(@PathVariable Long ordemServicoId
		...
		Comentario comentario = gestaoOsService.adicionarComentario(ordemServicoId, comentarioInput.getDescricao());
